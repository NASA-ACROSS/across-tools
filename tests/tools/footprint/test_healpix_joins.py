...
def test_inner_join_should_return_list(simple_footprint: Footprint) -> None:
    """
...
def test_inner_join_should_return_list_of_ints(simple_footprint: Footprint) -> None:
    """
...
def test_inner_join_should_return_empty_with_non_overlapping_footprints(simple_footprint: Footprint) -> None:
    """
...
def test_inner_join_should_return_empty_with_empty_footprint() -> None:
    """
...
def test_inner_join_should_raise_value_error_with_invalid_healpix_order(
    ...
    with pytest.raises(ValueError):
        inner(footprints=[simple_footprint], order=invalid_healpix_order)


def test_outer_join_should_return_list(simple_footprint: Footprint) -> None:
    """
...
def test_outer_join_should_return_list_of_ints(simple_footprint: Footprint) -> None:
    """
    Should return a list of ints when it is called with any overlap.
    """
    non_overlapping_footprints = [
...
def test_outer_join_should_return_empty_with_completely_overlapping_footprints(
...
def test_outer_join_should_return_empty_with_empty_footprint() -> None:
    """
    Should return an empty list when the list of footprint list are empty.
    """
...
def test_outer_join_should_raise_value_error_with_invalid_healpix_order(
    simple_footprint: Footprint, invalid_healpix_order: Any
) -> None:
    """
    Should raise ValueException when order is out of bounds of 0 <= order < 13.
    """
    with pytest.raises(ValueError):
        outer(footprints=[simple_footprint], order=invalid_healpix_order)


def test_union_join_should_return_list(simple_footprint: Footprint) -> None:
    """
...
def test_union_join_should_return_list_of_ints(simple_footprint: Footprint) -> None:
    """
    Should return a list of ints when it is called with any overlap.
    """
    non_overlapping_footprints = [
...
def test_union_join_should_return_empty_with_empty_footprint() -> None:
    """
    Should return an empty list when the list of footprint list are empty.
    """
...
def test_union_join_should_raise_value_error_with_invalid_healpix_order(
    simple_footprint: Footprint, invalid_healpix_order: Any
) -> None:
    """
    Should raise ValueException when order is out of bounds of 0 <= order < 13.
    """
    with pytest.raises(ValueError):
        union(footprints=[simple_footprint], order=invalid_healpix_order)
